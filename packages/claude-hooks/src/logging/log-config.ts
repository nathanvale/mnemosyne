...
export class LogConfig {
   ...
   */
  static getTranscriptParserConfig(
    options: LogConfigOptions = {},
  ): TranscriptParserConfig {
    const defaults = LogConfig.getDefaultOptions()
   ...
   */
  static createConfiguredEventLogger(
    options: LogConfigOptions = {},
  ): EventLogger {
   ...
   */
  static createConfiguredTranscriptParser(
    options: LogConfigOptions = {},
  ): TranscriptParser {
