  ...
  describe('Relationship Dynamics Analysis (Task 3.1-3.2)', () => {
    describe('Intimacy Level Assessment', () => {
          ...
          messages: [
            {
              id: 'msg1',
              content:
                'I feel so scared about telling you this, but I need to share something deeply personal with you',
              authorId: 'user1',
              timestamp: new Date('2024-01-01T10:00:00Z'),
            },
            {
              id: 'msg2',
              content:
                "I love you and I'm here for you no matter what. You can trust me with anything",
              authorId: 'user2',
            ...
            },
            {
              id: 'msg3',
              content:
                'Thank you for being my safe space. You mean everything to me',
              authorId: 'user1',
          ...
          messages: [
            {
              id: 'msg1',
              content:
                "I've been having a tough time at work lately and could use some advice",
              authorId: 'user1',
              timestamp: new Date('2024-01-01T14:00:00Z'),
            },
            {
              id: 'msg2',
              content:
                "I'm sorry to hear that. What kind of challenges are you facing?",
              authorId: 'user2',
            ...
            },
            {
              id: 'msg3',
              content:
                'Thanks for listening. That really helps put things in perspective',
              authorId: 'user1',
      ...
      it('should detect low intimacy from professional or distant communication', () => {
        const lowIntimacyConversation: ConversationData =
            ...
            messages: [
              {
                id: 'msg1',
                content:
                  'Hello, I wanted to follow up on our previous discussion about the project timeline',
                authorId: 'user1',
                timestamp: new Date('2024-01-01T16:00:00Z'),
              },
              {
    ...
    describe('Communication Style Assessment', () => {
      it('should identify emotional vulnerability indicators', () => {
        const vulnerableConversation: ConversationData =
          createTestConversationData({
            ...
            messages: [
              {
                id: 'msg1',
                content:
                  "I'm really struggling with something and I don't know who else to turn to",
                authorId: 'user1',
                timestamp: new Date('2024-01-01T12:00:00Z'),
              },
              {
                id: 'msg2',
                content:
                  "I hear you. It takes courage to reach out. What's going on?",
                authorId: 'user2',
              ...
              },
              {
                id: 'msg3',
                content:
                  "I made a terrible mistake and I'm so ashamed. I'm afraid you'll judge me",
                authorId: 'user1',
        ...
        expect(dynamics.communicationStyleDetails.vulnerabilityLevel).toBe(
          'high',
        )
        expect(dynamics.communicationStyleDetails.emotionalSafety).toBe('high')
        expect(dynamics.communicationStyleDetails.supportPatterns).toContain(
          'active_listening',
        )
        expect(dynamics.communicationStyleDetails.supportPatterns).toContain(
          'validation',
      ...
      it('should detect conflict and tension patterns', () => {
        const conflictConversation: ConversationData =
          createTestConversationData({
            id: 'conv-conflict-1',
            ...
            messages: [
              {
                id: 'msg1',
                content:
                  "I can't believe you did that without consulting me first",
                authorId: 'user1',
                timestamp: new Date('2024-01-01T18:00:00Z'),
              },
              {
              ...
              },
              {
                id: 'msg3',
                content:
                  "Don't dismiss my feelings like that. This is exactly what I'm talking about",
                authorId: 'user1',
        ...
        const dynamics =
          analyzer.analyzeRelationshipDynamics(conflictConversation)

        expect(dynamics.conflictLevel).toBe('high')
        expect(dynamics.communicationStyleDetails.emotionalSafety).toBe('low')
        expect(dynamics.communicationStyleDetails.conflictPatterns).toContain(
          'dismissal',
        )
        expect(dynamics.communicationStyleDetails.conflictPatterns).toContain(
          'defensiveness',
      ...
      it('should recognize therapeutic or counseling communication patterns', () => {
        const therapeuticConversation: ConversationData =
          createTestConversationData({
            ...
            messages: [
              {
                id: 'msg1',
                content:
                  "I've been having these thoughts and I'm not sure how to process them",
                authorId: 'client',
                timestamp: new Date('2024-01-01T15:00:00Z'),
              },
              {
                id: 'msg2',
                content:
                  'Can you tell me more about what these thoughts are like for you?',
                authorId: 'therapist',
              ...
              },
              {
                id: 'msg3',
                content:
                  'When you ask it that way, I realize there might be a pattern here',
                authorId: 'client',
        ...
        expect(dynamics.communicationStyleDetails.professionalBoundaries).toBe(
          true,
        )
        expect(dynamics.communicationStyleDetails.guidancePatterns).toContain(
          'reflective_questioning',
        )
        expect(
          dynamics.communicationStyleDetails.therapeuticElements,
        ).toContain('insight_facilitation')
        expect(dynamics.supportLevel).toBe('high')
      })
    })
    ...
    describe('Participant Dynamics Evaluation', () => {
      it('should identify emotional leader and supporter roles', () => {
        const supportConversation: ConversationData =
          createTestConversationData({
            id: 'conv-support-1',
            ...
            messages: [
              {
                id: 'msg1',
                content:
                  "Everything feels like it's falling apart and I don't know what to do",
                authorId: 'supported',
                timestamp: new Date('2024-01-01T20:00:00Z'),
              },
              {
                id: 'msg2',
                content:
                  "I can see you're in a lot of pain right now. Let's take this one step at a time",
                authorId: 'leader',
        ...
        const dynamics =
          analyzer.analyzeRelationshipDynamics(supportConversation)
        ...
        expect(dynamics.participantDynamics.vulnerabilityExhibitor).toBe(
          'supported',
        )
        expect(dynamics.participantDynamics.supportBalance).toBe(
          'unidirectional',
        )
      })

      it('should detect mutual support patterns', () => {
        const mutualSupportConversation: ConversationData =
          createTestConversationData({
            id: 'conv-mutual-1',
            ...
            messages: [
              {
                id: 'msg1',
                content:
                  'Thank you for helping me through that difficult time last week',
                authorId: 'user1',
                timestamp: new Date('2024-01-01T22:00:00Z'),
              },
              {
                id: 'msg2',
                content:
                  "Of course! You've been there for me so many times too",
                authorId: 'user2',
              ...
              },
              {
                id: 'msg3',
                content:
                  "Actually, I've been struggling with something new and could use your perspective",
                authorId: 'user2',
    ...
    describe('Emotional Safety Evaluation', () => {
          ...
          messages: [
            {
              id: 'msg1',
              content:
                "I need to tell you something that I'm really ashamed about",
              authorId: 'user1',
              timestamp: new Date('2024-01-02T09:00:00Z'),
            },
            {
              id: 'msg2',
              content:
                'Whatever it is, I love you and nothing will change that',
              authorId: 'user2',
            ...
            },
            {
              id: 'msg4',
              content:
                'Thank you for trusting me with this. We all make mistakes. What matters is how we learn and grow',
              authorId: 'user2',
      ...
      it('should detect medium emotional safety with some reservations', () => {
        const moderateSafetyConversation: ConversationData =
          createTestConversationData({
            ...
            messages: [
              {
                id: 'msg1',
                content:
                  "I'm not sure how you'll react to this, but I need to share something",
                authorId: 'user1',
                timestamp: new Date('2024-01-02T13:00:00Z'),
              },
              {
                id: 'msg2',
                content:
                  "I'm listening. Though I have to say, you've been making some questionable choices lately",
                authorId: 'user2',
